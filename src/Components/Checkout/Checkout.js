    ...
    const itemList = (item) => {
        ...
        return (
            <li className="list-group-item d-flex justify-content-between lh-sm">
                <Row>
                    <Col className="col-2 fs-6 fw-bold d-flex  align-items-center">
                       <span className='fs-6'>1X</span> 
                    </Col>  
                    <Col  className="col-10 my-0 fs-6 fw-light">{item.product_name}</Col>
                </Row>
                <span className="text-muted">AED {item.price}</span>
            </li>
        );
    }
